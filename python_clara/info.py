...
# NSF Parameters
NSF_SOURCE_NODE   = 3  # source
NSF_DEST_NODE     = 9  # destination node
NSF_NUM_NODES     = 13 # number of nodes on NSF network
...
GA_MIN_GEN        = 35    # min number of generations
GA_MAX_GEN        = 100   # max number of generations
